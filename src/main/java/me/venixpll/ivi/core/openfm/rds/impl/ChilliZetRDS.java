...
public class ChilliZetRDS extends RDS {

    //https://rds.eurozet.pl/reader/var/zetchilli.json?callback=rdsData
    ...
    public RDSData readRDS() throws Exception {
        final var obj = HttpUtils.getRaw("https://rds.eurozet.pl/reader/var/zetchilli.json?callback=rdsData");
