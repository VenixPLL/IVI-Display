...
public class AntyRadioRDS extends RDS {

    //https://rds.eurozet.pl/reader/var/antyradio.json?callback=rdsData
    ...
    public RDSData readRDS() throws Exception {
        final var obj = HttpUtils.getRaw("https://rds.eurozet.pl/reader/var/antyradio.json?callback=rdsData");
