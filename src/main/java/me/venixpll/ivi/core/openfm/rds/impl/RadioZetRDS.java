...
public class RadioZetRDS extends RDS {

    // //https://rds.eurozet.pl/reader/var/radiozet.json?callback=rdsData
    ...
    public RDSData readRDS() throws Exception {
        final var obj = HttpUtils.getRaw("https://rds.eurozet.pl/reader/var/radiozet.json?callback=rdsData");
